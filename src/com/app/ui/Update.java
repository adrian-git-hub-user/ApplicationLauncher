...
import com.app.deviceapplications.Utilities;
...
public class Update extends Activity {
    ...
    private void updateView(String userInput){ 	
    	...
    	List<AppInfoDetails> a = Utilities.getInstalledApplicationByName(userInput , this);
    	
    	adapter = new AppInfoAdapter(this, a , getPackageManager());
	...
	public Update(){
        ...
        mListAppInfo.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView parent, View view, int pos, long id) {
                ...
                if(com.app.config.Config.DISPLAY_PACKAGE_NAME){
